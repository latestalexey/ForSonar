...
Функция ЗаписатьНастройки()
	...
	ЗаписатьСертификатыПоУмолчанию();
...
Процедура КоманднаяПанель1ВыбратьСертификатПоУмолчанию(Кнопка)
	
	МодульДД_ОФ = ПолучитьФорму("ФормаСервис_ПодписаниеДД",ЭтаФорма,Новый УникальныйИдентификатор);	
	ВыбранноеЗначение = МодульДД_ОФ.ВыбратьСертификат();
	Если ВыбранноеЗначение<>Неопределено Тогда 
		ЗаполнитьЗначенияСвойств(ЭлементыФормы.СписокСертификатов.ТекущиеДанные,ВыбранноеЗначение);
	КонецЕсли;
	
КонецПроцедуры

Процедура КоманднаяПанель1СписокСертификатовОчиститьСертификатПоУмолчаниюПоОрганизации(Кнопка)
	ТекСтрока=ЭлементыФормы.СписокСертификатов.ТекущиеДанные;
...
Процедура ЗаполнитьНазначенныеСертификаты()
	...
	СписокНазначенныхСертификатов=СертификатыПоУмолчанию();
	
	МодульДД_ОФ = ПолучитьФорму("ФормаСервис_ПодписаниеДД",ЭтаФорма,Новый УникальныйИдентификатор);	
	МассивСертификатов = МодульДД_ОФ.МассивСертификатов();
...
Процедура ЗаписатьСертификатыПоУмолчанию()

	Для Каждого СтрокаСертификатаПоУмолчанию из СписокСертификатов Цикл
		УстановитьЗначениеСвойстваОбъекта(СтрокаСертификатаПоУмолчанию.Организация, "ОтпечатокСертификата",СтрокаСертификатаПоУмолчанию.Отпечаток);
	КонецЦикла;
